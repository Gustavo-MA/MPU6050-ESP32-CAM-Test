...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
   //if (true) {
    ...
    String json = "{\"id\":\"Acelerometro\",\"AcX\":"+String(ax)+",\"AcY\":"+String(ay)+",\"AcZ\":"+String(az)+",\"GiX\":"+String(gx)+",\"GiY\":"+String(gy)+",\"GiZ\":"+String(gz)+"}";
    ...
    client.publish("FCaEI/mqtt/GMA/Acelerometro", char_array); 
...
void reconnect() {
  ...
  while (!client.connected()) { // Pregunta si hay conexión
    ...
    if (client.connect("ESP32CAMClient")) { //Pregunta por el resultado del intento de conexión
      ...
      client.subscribe("FCaEI/mqtt/GMA/Acelerometro"); // Esta función realiza la suscripción al tema
